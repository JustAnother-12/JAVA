<?php
     ...
     if ($result->num_rows == 1) {
          ...
          if ($account["Lock"] == 0) {
               ...
               if (in_array($account["RoleID"], ['R1', 'R2', 'R3'])) {
                    $username = $account["Username"];
                    $sqlEmployee = "SELECT EmployeeID FROM employee WHERE Username = ?";
                    ...
                    if ($resultEmployee->num_rows == 1) {
                        ...
                        $_SESSION["employeeID"] = null; // Nếu không tìm thấy thì để null
                    }
                }
            ...
            if (isset($_SESSION["cart"]) && !empty($_SESSION["cart"])) {
               ...
               switch ($account["RoleID"]) {
                    ...
                    case "R3":
                         ...
                         exit;
                    case "R2":
                         header("Location: http://localhost:8004/stock/stock.php");                         
                         exit;
                    case "R1":
